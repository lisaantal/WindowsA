...
#[derive(Debug)]
pub struct WindowsAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl WindowsAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WindowsAPI processing");
    
    let mut processor = WindowsAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WindowsAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WindowsAPIProcessor::new(false);
